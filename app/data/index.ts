...
Analyze and rate this resume thoroughly and critically. Be honest and strict: low scores are fine if the resume has major issues.

The job title is: ${jobTitle}
The job description is: ${jobDescription}

⚠️ Rules for your response:
- Output ONLY a valid JSON object in the following format: ${AIResponseFormat}
